...
public class StringQueryRunner extends AbstractQueryRunner{
	  /**
     * Constructor for QueryRunner.
     */
    public StringQueryRunner() {
        super();
    }
     ...
     */
    public StringQueryRunner(boolean pmdKnownBroken) {
     ...
     */
    public StringQueryRunner(DataSource ds) {
        super(ds);
    }
     ...
     * and if it breaks, we'll remember not to use it again.
     */
    public StringQueryRunner(DataSource ds, boolean pmdKnownBroken) {
     ...
     * @throws SQLException
     */
    private Map<String,Object> update(Map<String,Object> map,Connection conn, boolean closeConn) throws SQLException{
    	if(map==null){
   		 throw new SQLException("sql map is null");
    	}
    	Map<String,Object> map_value = new HashMap<String,Object>(map.size());
    	if (conn == null) {
    		throw new SQLException("Null connection");
    	}
	   	PreparedStatement stmt = null;
	       ...
	       try {
	       	for(Map.Entry<String, Object> entry:map.entrySet()){
	       		...
	       		value = "".equals(value)||null==value?  null:value;
	            this.fillStatement(stmt,(Object[])value);
	            rows = stmt.executeUpdate();
	            map_value.put(entry.getKey(), String.valueOf(rows));
	       	}
       	
	       } catch (SQLException e) {
	           throw new SQLException("Update sql false---> sql rollback  into  "+e.getMessage()+" sql is" + sql);
	       } finally {
	           close(stmt);
	           if (closeConn) {
	               close(conn);
    ...
    public Map<String,Object> update(Map<String,Object> map) throws SQLException{
    	Connection conn = this.prepareConnection();
        return this.update(map,conn,true);
    }
    /**
     * Calls update after checking the parameters to ensure nothing is null.
    ...
    private int update(Connection conn, boolean closeConn, String sql, Object... params) throws SQLException {
        ...
        int insertCount = sql.toUpperCase().indexOf("INSERT");
        ResultSet rs = null;
